...
public final class WorldRenderer implements Disposable
{
    ...
    // Chunk loader.
    public boolean forceCheck = false, forceDirty = false;
    ...
    public WorldRenderer(World world, int maxDis) {
        this.world = world;
    ...
    public void render(Camera cam) {
        ...
        // PartBench is a neat Arcubit function i might re-add here
        //if (!PartiBench.isBench) clouds.render(cam, indices);

        TextureUtils.missing.getTexture().bind();
